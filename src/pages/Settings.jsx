...
const Settings = () => {
  return (
    <div className="section space-y-10">
      ...
      {/* Account Settings */}
      <div className="bg-warning rounded-2xl shadow p-6 space-y-6">
          ...
          {[
            ...
            <div key={idx}>
              ...
              <input
                ...
                className="w-full p-2 mt-1 border border-gray-300 bg-white text-black rounded-md"
              />
            </div>
          ))}
        </div>
        <button className="mt-4 px-4 py-2 bg-[#db8a74] hover:bg-[#c37964] text-white rounded-md flex items-center">
